...
const CurrentEvent = () => {
    return (
        <div
            style={{ backgroundColor: "black !important", overflow: "hidden" }}>
            <section className="event2" style={{ backgroundColor: "black" }}>
                <div
                    className="yearly_events1"
                    ...
                    <section
                        ...
                        <div
                            ...
                            <div className="allevent_card style1">
                                <a
                                    href="https://forms.gle/cfvfYs36wf4EnaqGA"
                                    target="_blank"
                                    rel="noreferrer">
                            ...
                            <div className="allevent_card style1">
                                <a
                                    href="https://forms.gle/mQENRwaSDACs6gpJ8"
                                    target="_blank"
                                    rel="noreferrer">
                                    <div className="event_info">
                                        <div className="event_info_img1">
                            ...
                            <div className="allevent_card style1">
                                <a
                                    href="https://forms.gle/Fb4huGeFYmQniUMf9"
                                    target="_blank"
                                    rel="noreferrer">
                                    <div className="event_info">
                                        <div className="event_info_img1">
                            ...
                            <div className="allevent_card style1">
                                <a
                                    href="https://forms.gle/V4aUiWGvV9CabJry8"
                                    target="_blank"
                                    rel="noreferrer">
                                    <div className="event_info">
                                        <div className="event_info_img1">
                            ...
                            <div className="allevent_card style1">
                                <a
                                    href=" https://forms.gle/sBaKy9UaWHm9By5u5"
                                    target="_blank"
                                    rel="noreferrer">
                                    <div className="event_info">
                                        <div className="event_info_img1">
                            ...
                            <div className="allevent_card style1">
                                <a
                                    href="https://forms.gle/WySr5Bqj67hmMPRE7"
                                    target="_blank"
                                    rel="noreferrer">
                                    <div className="event_info">
                                        <div className="event_info_img1">
                            ...
                            <div className="allevent_card style1">
                                <a
                                    href="https://forms.gle/4CWXMPW4q3t52tZr8"
                                    target="_blank"
                                    rel="noreferrer">
                                    <div className="event_info">
                                        <div className="event_info_img1">
                            ...
                            <div className="allevent_card style1">
                                <a
                                    href="https://forms.gle/NNuz7CVmJ1BP7MXK9"
                                    target="_blank"
                                    rel="noreferrer">
                                    <div className="event_info">
                                        <div className="event_info_img1">
            ...
            <section className="event2" style={{ backgroundColor: "black" }}>
                <div
                    ...
                    <div
                        ...
                        <p
                            className="section-title"
                            style={{ fontFamily: "Gotu", color: "white" }}>
                            Intercollege Competition
                        </p>
                    </div>
                </div>
                <section id="all_events1" style={{ backgroundColor: "black" }}>
                    <section
                        ...
                        <div
                            ...
                            <div className="allevent_card style1">
                                <a
                                    href="https://forms.gle/T5KBSQWZdjXG3h1D6"
                                    target="_blank"
                                    rel="noreferrer">
                                    <div className="event_info">
                                        <div className="event_info_img1">
                            ...
                            <div className="allevent_card style1">
                                <a
                                    href="https://forms.gle/1ctKyZe2cWCewNhM6"
                                    target="_blank"
                                    rel="noreferrer">
                                    <div className="event_info">
                                        <div className="event_info_img1">
                            ...
                            <div className="allevent_card style1">
                                <a
                                    href="https://forms.gle/NN1P6WESATe79LF27"
                                    target="_blank"
                                    rel="noreferrer">
                                    <div className="event_info">
                                        <div className="event_info_img1">
                            ...
                            <div className="allevent_card style1">
                                <a
                                    href="https://forms.gle/cG9UB97cxv2kpzg26"
                                    target="_blank"
                                    rel="noreferrer">
                                    <div className="event_info">
                                        <div className="event_info_img1">
                            ...
                            <div className="allevent_card style1">
                                <a
                                    href="https://forms.gle/hZef8ZC1WMpL3T3dA"
                                    target="_blank"
                                    rel="noreferrer">
                                    <div className="event_info">
                                        <div className="event_info_img1">
                            ...
                            <div className="allevent_card style1">
                                <a
                                    href="https://forms.gle/QJC6Ggwi3h7PdANXA"
                                    target="_blank"
                                    rel="noreferrer">
                                    <div className="event_info">
                                        <div className="event_info_img1">
